...
if [ ${no_of_variants} -gt 0 ]; then
	...
	/home/diagnostics/pipelines/WholeExomePipeline/scripts/extract_vaf.py ${vcf_file} ${sample}.extracted.csv
	...
	/home/diagnostics/pipelines/WholeExomePipeline/scripts/extract_vepdata.py ${sample}_vep_delheaders.txt ${sample}.extractedvepdelheaders.csv

	# Merge vep and and vcf data
	/home/diagnostics/pipelines/WholeExomePipeline/scripts/mergeDeepVariantVep.py ${sample}.extracted.csv ${sample}.extractedvepdelheaders.csv ${output_name}
