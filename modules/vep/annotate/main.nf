...
process VEP_ANALYSIS {
	...
	vep -i pindel_filtered.vcf --cache -o ${Sample}_vep.txt --offline --merged --tab --force_overwrite --fasta ${GenFile} --symbol --protein --af --max_af  --no_check_alleles --sift b --variant_class --canonical --allele_number --hgvs --shift_hgvs 1 --af_1kg --af_gnomadg --pubmed
