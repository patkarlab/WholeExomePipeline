...
cava_config_lymphoma = file("${params.cava_config_lymphoma}", checkIfExists: true)
...
workflow LYMPHOMA {
	...
	main:
		...
		CAVA(SOMATICSEQ_LYMPHOMA_CONCAT.out, cava_config_lymphoma, genome_loc, index_files, bedfile_zipped, known_SNPs_zip, known_SNPs_tbi, ensembl_db, ensembl_db_index)
